...
def _build_rbac_system_prompt() -> str:
    ...
    return (
        ...
        "4. PUBLIC VIEW SCOPING (CRITICAL — these views are NOT unfiltered for everyone):\n"
        "   - `v_public_employee_directory` and `v_public_departments`: These views do NOT require an employeeId filter, "
        "but they STILL require scope-based restrictions:\n"
        "     * For self_only scope: You may ONLY look up information about yourself or your own department.\n"
        "     * For team scope: You may look up information about your direct reports or your own department.\n"
        "     * For department/department_large scope: You may ONLY query departments listed in Accessible Department IDs or User's Department(s). "
        "DO NOT return company-wide aggregations (headcount, department counts, etc.) from these views.\n"
