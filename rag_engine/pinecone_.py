...
class PineconeDB:
    ...
    ##### NOTE: Samu, a context manger should be used here as it's a resources we are trying to manage here.
    ...
    def init_index(self, ) -> Any:
        for _ in range(2):
            try:
                ...
                print(f"An Error Occurred reasons due to {reason}")

    def upsert_to_index(self, id: List[str], embeddings: List[Any], metadata: List[Dict],
