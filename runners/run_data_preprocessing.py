...
mysql_credentials_params = config['production']['mysql_credentials']
data_dir = config['production']['params_config']['data_dir']


def establish_connections():
    auth_adls_conn = adls_connection.ADLSConnection(mysql_credentials_params['auth_db_name'], adls_credentials_params)
    utils_adls_conn = adls_connection.ADLSConnection(mysql_credentials_params['utils_db_name'], adls_credentials_params)
