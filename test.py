...
for pdf_url in blob_urls:
    ...
    store_chunks_in_chromadb(chunks=chunks, index_name=index_name)
...
#     result = await async_client.fetch_many(query)  # Add await here
#     return result
#
#
# question = {
...
# }
# output = asyncio.run(main(question))  # Run the async function
# print(output)
# print(len(output))
